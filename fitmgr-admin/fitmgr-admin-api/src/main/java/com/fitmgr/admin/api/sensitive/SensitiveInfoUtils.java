package com.fitmgr.admin.api.sensitive;
...
public class SensitiveInfoUtils {
     ...
     * [密码] 全部隐藏<例子：1234 => **** >
     */
    public static String fixedPassword(final String num) {
        if (StringUtils.isBlank(num)) {
            return "";
        }
        return StringUtils.leftPad(StringUtils.right(num, 0), StringUtils.length(num), "*");
    }
